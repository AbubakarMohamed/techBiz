...
export const metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://techbiz.co.ke'),
  title: {
    template: '%s | Techbiz Limited',
    default: 'Techbiz Limited - Enterprise Technology Solutions in Kenya'
  },
  description: 'Leading technology consultancy providing custom software development, system integration, ERP solutions, and digital transformation services across Kenya and Africa.',
  keywords: 'technology solutions, software development, system integration, ERP, SAP, digital transformation, Kenya, Africa, enterprise software',
  ...
  openGraph: {
    ...
    description: 'Leading technology consultancy providing custom software development, system integration, and digital transformation services across Kenya and Africa.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'Techbiz Limited - Enterprise Technology Solutions',
    description: 'Leading technology consultancy in Kenya providing enterprise software solutions and digital transformation services.',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Leading technology consultancy providing enterprise software solutions and digital transformation services across Kenya and Africa.",
              "address": {
                "@type": "PostalAddress",
                "addressCountry": "KE",
              ...
              "sameAs": [
                "https://www.linkedin.com/company/techbiz-limited"
              ]
            })
          }}
        />
