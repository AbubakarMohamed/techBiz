...
export default function OfficeMap() {
  ...
  const locations = [
    {
      ...
      mapUrl:
        "https://maps.google.com/maps?q=Dr+Rashid+Ali+Rd,Mombasa,Kenya&ll=-4.043740,39.658871&z=15",
    ...
    },
    {
      ...
      address:
        "Office Suites, 2nd Floor, Block B ,Parklands Road\n,Kenya\nP.O BOX 49459 - 00100",
      phone: "+254 711 377 232",
      email: "info@techbizafrica.com",
      hours: {
        weekday: "Monday - Friday: 8:00 AM - 5:00 PM (EAT)",
      ...
      mapUrl:
        "https://maps.google.com/maps?q=Parklands+Road,Nairobi,Kenya&ll=-1.286389,36.817223&z=15",
      gradient: "from-blue-50 to-blue-100",
      iconColor: "text-blue-600",
      embedUrl:
  ...
  return (
    <section
      id="office-map"
      className="relative py-4 px-3 bg-white overflow-hidden"
      aria-labelledby="office-locations-title"
    >
      <div
        className="absolute top-[-10%] right-[-20%] w-[180%] h-[320px] opacity-[0.12] pointer-events-none"
        aria-hidden
      >
        <svg
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 border border-gray-100 shadow-lg w-full">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#0f1724]">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  <div
                    className={`w-10 h-10 bg-gradient-to-br ${activeLocationData.gradient} rounded-lg flex items-center justify-center flex-shrink-0`}
                  >
                    <MapPin
                      className={`w-5 h-5 ${activeLocationData.iconColor}`}
                    />
                  </div>
                  <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6 pt-6 border-t border-gray-200">
                <button
                  onClick={() =>
                    window.open(activeLocationData.mapUrl, "_blank")
                  }
                  className="flex-1 bg-[#0f4c81] hover:bg-[#0d3f6b] text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                >
                ...
                <a
                  ...
                  className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center gap-2"
                >
          ...
          <motion.div
            variants={itemVariants}
            className="min-h-[420px] md:min-h-[520px] order-1 lg:order-2"
          >
