...
export default function ContactMethod() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden py-12 flex items-center">
        <div
          className="absolute top-[-10%] md:top-[-8%] right-[-20%] md:right-[-10%] w-[180%] md:w-[140%] h-[180px] md:h-[320px] opacity-[0.16] pointer-events-none"
          aria-hidden
        >
          <svg
        ...
        <div
          className="absolute inset-0 bg-[radial-gradient(circle_at_18%_82%,rgba(15,76,129,0.04),transparent_40%),radial-gradient(circle_at_82%_18%,rgba(120,119,198,0.03),transparent_40%)] pointer-events-none"
          aria-hidden
        />

        <div
          className="absolute top-[6%] md:top-[10%] right-[-10%] md:right-[-6%] w-[140px] md:w-[220px] h-[140px] md:h-[220px] bg-gradient-to-br from-[rgba(120,119,198,0.14)] to-[rgba(255,119,198,0.1)] rounded-[40%_60%_60%_40%] blur-[30px] pointer-events-none"
          aria-hidden
        />

        <div
          className="absolute bottom-[6%] md:bottom-[10%] left-[-8%] md:left-[-4%] w-[120px] md:w-[200px] h-[120px] md:h-[200px] bg-gradient-to-br from-[rgba(120,200,255,0.1)] to-[rgba(120,119,198,0.08)] rounded-[60%_40%_50%_50%] blur-[28px] pointer-events-none"
          aria-hidden
        />
          ...
          >
            {contactMethods.map((method, idx) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${method.gradient} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-sm`}
                  >
                    <IconComponent
