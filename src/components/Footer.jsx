  ...
  import { Linkedin, Instagram, Twitter, Facebook, Youtube, Phone, Mail, MapPin } from "lucide-react"
    ...
    return (
      <footer className="relative bg-slate-900 text-white overflow-hidden" role="contentinfo">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-20">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-8 md:gap-12 mb-16">
            ...
            <div className="md:col-span-2 lg:col-span-2 space-y-8">
              ...
              <p className="text-slate-300 text-base leading-relaxed max-w-md">
                Your Digital Partner - Empowering businesses with innovative technology solutions since 2005.
              </p>

              <address className="not-italic text-slate-300 space-y-4">
                <a href="tel:+254711377232" className="flex items-center gap-2 font-medium text-white hover:underline focus:outline-none rounded text-base">
                  <Phone className="w-4 h-4 text-slate-400" />
                  +254 711 377 232
                </a>
                <a href="mailto:info@techbizafrica.com" className="flex items-center gap-2 font-medium text-white hover:underline focus:outline-none rounded text-base">
                  <Mail className="w-4 h-4 text-slate-400" />
                  info@techbizafrica.com
                </a>
                <div className="text-sm leading-relaxed pt-2">
                  <div className="mb-4">
                    <p className="font-medium text-white mb-1">Nairobi Branch</p>
                  ...
                  <div>
                    <p className="font-medium text-white mb-1">Mombasa Branch</p>
                     <div className="flex items-center gap-2 mt-1">
                      <MapPin className="w-4 h-4 text-slate-400" />
              ...
              <div className="flex items-center space-x-4 pt-2">
                <SocialLink href="https://www.linkedin.com/company/techbiz-ltd/" label="LinkedIn"><Linkedin className="w-6 h-6" /></SocialLink>
                <SocialLink href="https://www.facebook.com/Techbizltd" label="Facebook"><Facebook className="w-6 h-6" /></SocialLink>
                <SocialLink href="https://www.instagram.com/techbizlimited/" label="Instagram"><Instagram className="w-6 h-6" /></SocialLink>
                <SocialLink href="https://x.com/techbizltd" label="Twitter"><Twitter className="w-6 h-6" /></SocialLink>
                <SocialLink href="https://www.youtube.com/@techbizltd" label="YouTube"><Youtube className="w-6 h-6" /></SocialLink>
              </div>
            </div>
            ...
            <FooterColumn title="Company">
              ...
              <FooterLink href="https://www.techbizafrica.com">Website</FooterLink>
            </FooterColumn>
          </div>
          ...
          <div className="border-t border-slate-700 pt-8">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="text-center lg:text-left">
                <p className="text-slate-500 text-base">© {new Date().getFullYear()} Techbiz Limited. All rights reserved.</p>
              ...
              {/* Legal Links */}
              <nav aria-label="Legal" className="flex flex-wrap items-center justify-center lg:justify-end gap-6 text-slate-400">
  ...
  function FooterColumn({ title, children }) {
    return (
      <div className="space-y-5">
        ...
        <ul className="space-y-3 mt-6 text-slate-300">{children}</ul>
      </div>
    )
  }
  ...
  function FooterLink({ href, children }) {
    return (
      <li>
        <Link href={href} className="block hover:text-white transition-colors focus:outline-none rounded text-base">
          {children}
        </Link>
      </li>
    )
  ...
  function FooterLegal({ href, children }) {
    return (
      <Link href={href} className="hover:text-white transition-colors focus:outline-none rounded text-sm">
        {children}
      </Link>
    )
  }
  ...
  function SocialLink({ href, children, label }) {
    return (
      <Link href={href} aria-label={label} className="text-slate-400 hover:text-white transition-colors focus:outline-none rounded p-1">
