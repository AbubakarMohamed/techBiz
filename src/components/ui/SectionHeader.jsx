    ...
    >
      {badge && (
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <span className={`inline-flex items-center gap-2 text-xs font-bold tracking-[0.25em] uppercase px-4 py-2 rounded-full border ${colors.badgeText} ${colors.badgeBg} ${colors.badgeBorder}`}>
