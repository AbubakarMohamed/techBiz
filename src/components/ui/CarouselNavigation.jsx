  ...
  const themeStyles = {
    light: {
      ...
      dotActive: {
        ...
        boxShadow: `0 10px 25px ${ACCENT}30`,
      },
      ...
      {showArrows && (
        <div className="hidden md:flex gap-4">
          <button
            ...
            style={
              theme === "light" ? { borderColor: currentTheme.arrowBorder } : {}
            }
          ...
          >
            <ArrowLeft
              ...
              {...(theme === "dark" && {
                className: `h-5 w-5 ${currentTheme.arrowIcon} transition-colors duration-300`,
              })}
            />
          </button>
          <button
