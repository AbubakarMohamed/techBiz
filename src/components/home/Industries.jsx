            ...
            >
              ...
              <div className="order-2 lg:order-2 relative">
                ...
                <div className="relative z-10 px-1 py-4 sm:px-2 sm:py-6">
                  ...
                  >
                    <p
                      className={`${inter.className} text-gray-700 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed font-medium pl-3 sm:pl-4 border-l-2 border-blue-500/25`}
                    >
                      {active.description}
                    </p>
                  </motion.div>
